        ...
        if (existingUser) {
            ...
            if (existingUser.block == false) {
                ...
                if (ispasswordMatch || password == existingUser.password) {
                    ...
                    const token = jwt.sign({ userid: existingUser._id, roll: existingUser.roll }, process.env.jwt_pass,{expiresIn:'7d'})
...
exports.adminLoginController = async (req, res) => {
    console.log("Inside the admin login controller");
